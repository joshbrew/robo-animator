# Pass file locations to this with subprocess.Popen(['python','TestRun.py',motor.cfg,anim.dat], shell=True)
# Or os.system('python TestRun.py motor.cfg anim.dat')
...
class PiRoboConfig(object):
    ...
    def __init__(self):
        ...
        self.motorCFGPath = sys.argv[2]
        self.animCFGPath = sys.argv[3]
